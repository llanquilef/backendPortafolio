...
# ROOT URL
ROOT_URLCONF = 'llanquiPageProject.urls'
...
WSGI_APPLICATION = 'llanquiPageProject.wsgi.application'
...
# SEND ERRORS IN DEBUG TO MY GMAIL / ENVIÓ DE ERRORES Y DEBUG A MI GMAIL
LOGGING = {
    'version': 1,
